...
В конфигураторе в форме документа ОтчетПоЗаданию изменить строчки 48-53 на те, которые больше подходят Вам, для запуска локального питона из 1с. Наш код настроен на windows клиент 1С. .
